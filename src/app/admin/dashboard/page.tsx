    ...
    <div className="flex-1 flex flex-col">
      <div className="border-b border-[#1D140F] px-8 py-4 flex items-center justify-between">
        ...
        <form action={logoutAction}>
          <button
            type="submit"
            className="text-[12px] uppercase tracking-widest font-mono text-slate-400 hover:text-[#C97352] transition-colors"
          >
            cerrar sesión
          </button>
        </form>
      ...
      <div className="flex-1 p-8 max-w-4xl mx-auto w-full space-y-8">
        <section>
          <div className="mb-4">
            <span className="text-[12px] uppercase tracking-widest text-slate-400 font-mono">
              // motor ia
            </span>
