...
import { Project, ProjectPlatform } from './data';
...
const PLATFORM_BADGE: Record<ProjectPlatform, string> = {
  web: 'WEB',
  android: 'ANDROID',
  both: 'WEB + ANDROID',
};
...
export function ProjectCard({ project, onClick, onAndroidRequest }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className="border-b border-slate-800 px-4 py-2 bg-[#030303] overflow-hidden flex items-center justify-between gap-2">
